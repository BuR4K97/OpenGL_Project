...
{
    class RenderableTreeBodyObject : RenderableObject
    {
        private const string _meshFile = "Graphics\\Models\\MeshModels\\TreeBody.obj";
        ...
        private static ObjectModel GetObjectModel()
        {
            ...
            Color4 defaultColor = new Color4(0.27f, 0.18f, 0.035f, 1.0f);
        ...
        public RenderableTreeBodyObject() : base(new SealedTransformableObject(_model, HierarchyPackage.SingularHierarchyPack), _colorPackage)
        {
