...
{
    class RenderableHomeFloorObject : RenderableObject
    {

        private const string _meshFile = "Graphics\\Models\\MeshModels\\HomeFloor.obj";
        ...
        private static ObjectModel GetObjectModel()
        {
            ...
            Color4 defaultColor = new Color4(0.55f, 0.17f, 0.10f, 1.0f);
        ...
        public RenderableHomeFloorObject() : base(new SealedTransformableObject(_model, HierarchyPackage.SingularHierarchyPack), _colorPackage)
        {
